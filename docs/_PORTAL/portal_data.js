...
window.AS2 = {
 ...
 "zoning": {
  ...
  "zones": [
   ...
   {
    "name": "Spine Shade Margin (S)",
    "fullName": "Spine Shade Margin (S)",
    "category": "Green",
    "area": 700.0,
    "pct": 4.7,
    "icon": "📍",
   ...
   {
    "name": "Spine Shade Margin (N)",
    "fullName": "Spine Shade Margin (N)",
    "category": "Green",
    "area": 700.0,
    "pct": 4.7,
    "icon": "📍",
   ...
   },
   {
    ...
    "fullName": "Path Network & Landscape Setbacks",
    "category": "Circulation",
    "area": 2240.0,
    "pct": 14.9,
    "icon": "📍",
 ...
 "planting": {
  ...
  "sourcePlanting": "../archive/phases/06_PHASE6_DETAILED_DESIGN/outputs/planting_schedule.json",
 ...
 "performance": {
  ...
  "recycledPct": 43.4,
  "sourceShade": "../archive/phases/07_PHASE7_PERFORMANCE_AND_SUSTAINABILITY/outputs/annual_shade_hours_results.json",
 ...
 "cost": {
  ...
  "capexPackage": {
   ...
   "total": 18634610.0,
   "source": "../archive/phases/07_PHASE7_PERFORMANCE_AND_SUSTAINABILITY/outputs/capex_breakdown.csv"
  },
  "opexPackage": {
   "items": [
    {
 ...
 "audit": [
  ...
  },
  {
   ...
   "status": "pass",
   "detail": "The spine achieves 90.55% annual shade against an ≥80% target."
  },
  {
   "name": "Phase 3 target: ≥60% green or soft-surface active space",
   "status": "warn",
   "detail": "Green, buffer and passive zones total 41.8% of the site. Counting the active soft-surface lawns as well brings the scheme to target; as categorised strictly, it does not."
  },
  {
