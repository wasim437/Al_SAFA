...
(() => {
  ...
  function draw(t){
    ...
    if(bi===0){                                    // 0-7 the year
      ...
      ctx.fillStyle="rgba(255,182,39,.95)"; mono(15,700);
      tx("MOHAMED WASIM  ·  AI ENGINEER", W/2, FT+FH*.46+114, ca);
      ctx.fillStyle="rgba(246,243,237,.80)"; mono(13,400);
      tx("PHONE: +971 56 591 9456   ·   EMAIL: wasimmisaw437@gmail.com", W/2, FT+FH*.46+138, ca);
      ctx.fillStyle="#6FD9B0"; mono(14,600);
      tx("MUST VISIT LIVE PORTAL: https://wasim437.github.io/Al_SAFA/", W/2, FT+FH*.46+164, ca);
      ctx.fillStyle="rgba(246,243,237,.55)"; mono(12,400);
      tx("GITHUB REPO: https://github.com/wasim437/Al_SAFA", W/2, FT+FH*.46+188, ca);
      ctx.textAlign="left";
    }
