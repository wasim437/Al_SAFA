...
P1 = os.path.join(ROOT, "01_PHASE1_EXISTING_PARK")
P2 = os.path.join(ROOT, "02_PHASE2_PROBLEM_DEFINITION", "outputs")
P5 = os.path.join(ROOT, "05_PHASE5_MASTERPLAN_DEVELOPMENT", "outputs")
P6 = os.path.join(ROOT, "06_PHASE6_DETAILED_DESIGN", "outputs")
P7 = os.path.join(ROOT, "07_PHASE7_PERFORMANCE_AND_SUSTAINABILITY", "outputs")
P9 = os.path.join(ROOT, "09_PHASE9_AI_WORKFLOW_AND_VISUALIZATION", "outputs")
P10 = os.path.join(ROOT, "10_PHASE10_UPLOAD_DOCUMENTS")
