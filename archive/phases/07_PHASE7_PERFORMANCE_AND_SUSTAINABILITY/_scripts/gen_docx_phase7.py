...
sections = [
    ...
    {"type": "image", "path": os.path.join(OUT_DIR, "monthly_spine_shade_pct.png"),
     ...
     "width_cm": 16},
    {"type": "para", "text": (
        "The Shaded Spine holds ≥97.3% shade coverage in every single month of the year, "
...
docx_path = build_docx_report(
    output_path=os.path.join(OUT_DIR, "..", "Phase7_Performance_and_Sustainability_Report.docx"),
