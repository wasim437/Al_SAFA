...
sections = [
    ...
    {"type": "bullets", "items": [
        ...
        "05:00–23:00, all seasons.",
    ]},
    {"type": "table", "header": ["Density Band", "Park Area Range (sqm)"], "rows": [
        ["High (>220 person/ha)", "3,000 – 150,000"],
        ["Medium (70–220 person/ha)", "3,500 – 300,000"],
        ["Low (<70 person/ha)", "4,000 – 500,000"],
    ]},
    {"type": "para", "text": (
    ...
    {"type": "para", "text": (
        ...
        "1–3 hours; peak visitor capacity 150–400 visitors per 10,000 sqm."
    )},
...
docx_path = build_docx_report(
    output_path=os.path.join(OUT_DIR, "Phase1.01_Regional_Analysis_Report.docx"),
