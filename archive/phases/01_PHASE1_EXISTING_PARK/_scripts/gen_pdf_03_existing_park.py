...
sections = [
    ...
    {"type": "para", "text": (
        ...
        "File Converter (opendesign.com) to convert DWG&rarr;DXF, or opening directly in "
...
build_report(
    output_path=os.path.join(OUT_DIR, "Phase1.03_Existing_Park_Analysis_Report.pdf"),
