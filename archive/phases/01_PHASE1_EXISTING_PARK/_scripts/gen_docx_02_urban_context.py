...
sections = [
    ...
    {"type": "para", "text": (
        "This report documents everything around the park — residential, commercial, "
        "schools, mosques, clinics, metro, roads — extracted from the official "
...
docx_path = build_docx_report(
    output_path=os.path.join(OUT_DIR, "Phase1.02_Urban_Context_Report.docx"),
