...
sections = [
    ...
    {"type": "table", "header": ["Metric", "Target (draft, to validate in Phase 7)"], "rows": [
        ["Shaded route coverage", "&ge;80% of primary circulation shaded at summer solar noon"],
        ["Accessible circulation", "100% of paths meet universal-design gradient/width standards"],
        ["Usable green/active space", "&ge;60% of site area as green/planted or soft-surface active space"],
...
build_report(
    output_path=os.path.join(OUT_DIR, "Phase3_Opportunity_and_Objectives_Report.pdf"),
